...
// ✅ ClaimSection BAHAR hai - ab re-render par naya component nahi banega
// Yeh fix karta hai focus lose hone ki problem
const ClaimSection = ({ text, setText, onClaim }) => (
    ...
    <main>
      ...
      <section className="bg-[#254f1a] min-h-screen grid grid-cols-1 md:grid-cols-2 px-4">
        <div className="flex justify-center flex-col md:ml-[10vw] gap-4 pt-32 md:pt-0">
          ...
          <ClaimSection text={text} setText={setText} onClaim={createTree} />
        </div>
